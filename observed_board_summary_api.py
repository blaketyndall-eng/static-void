...
app = FastAPI(title="Observed Board Summary API")
telemetry = TelemetryLogger(filepath="var/decision_board_telemetry.jsonl")


@app.get("/api/v1/decision-board/summary-observed")
def get_decision_board_summary_observed(db: Session = Depends(get_db)) -> dict:

...
from packages.routers.product_combined_views import router as combined_views_router
...
app = FastAPI(title="Full Router-Based Packaged Product Surface API")
...
app.include_router(combined_views_router)

...
from telemetry_events import EVALUATION_READINESS_VIEWED
from telemetry_helpers import emit_view_event
from telemetry_logger import TelemetryLogger

app = FastAPI(title="Observed Evaluation Readiness API")
telemetry = TelemetryLogger(filepath="var/evaluation_surface_telemetry.jsonl")


@app.get("/api/v1/evaluations/{evaluation_id}/readiness-observed")
def get_evaluation_readiness_observed(evaluation_id: str, db: Session = Depends(get_db)) -> dict:

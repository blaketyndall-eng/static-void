...
router = APIRouter(prefix="/api/v1/software-engineering", tags=["software_engineering_summary"])
telemetry = TelemetryLogger(filepath="var/software_engineering_telemetry.jsonl")


@router.get("/summary")
def get_software_engineering_summary(db: Session = Depends(get_db)) -> dict:
    ...
    emit_view_event(
        ...
        route="get_software_engineering_summary",
